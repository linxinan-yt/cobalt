...
component_info: ChromeLatencyInfoComponentInfo, msg, 4,    is_coalesced: bool, primitive, 5,
    gesture_scroll_id: i64, primitive, 6,
    touch_id: i64, primitive, 7,
    input_type: ChromeLatencyInfoInputType, enum, 8,
});

pb_msg!(ChromeLatencyInfoComponentInfo {    component_type: ChromeLatencyInfoLatencyComponentType, enum, 1,
