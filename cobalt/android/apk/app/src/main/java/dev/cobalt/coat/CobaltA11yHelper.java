...
class CobaltA11yHelper extends ExploreByTouchHelper {
        ...
        switch (currentFocusedViewId) {
            ...
            case UP_VIEW_ID:
                cobaltActivity.onKeyDown(
                        ...
                        new KeyEvent(KeyEvent.KEYCODE_DPAD_UP, KeyEvent.ACTION_DOWN));
                cobaltActivity.onKeyUp(
                        KeyEvent.KEYCODE_DPAD_UP,
                        new KeyEvent(KeyEvent.KEYCODE_DPAD_UP, KeyEvent.ACTION_UP));
                break;
            case LEFT_VIEW_ID:
                cobaltActivity.onKeyDown(
     ...
     * </pre>
     *
     * <p>The focus always starts from the middle number 5. When user changes focus, the focus is
     * then moved to either 2, 4, 6 or 8 and we can capture the movement this way. The focus is then
