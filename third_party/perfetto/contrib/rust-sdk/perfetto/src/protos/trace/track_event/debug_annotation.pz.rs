...
nested_value: DebugAnnotationNestedValue, msg, 8,    legacy_json_value: String, primitive, 9,
...
pb_msg!(DebugAnnotationNestedValue {
    ...
    array_values: DebugAnnotationNestedValue, msg, 4,    int_value: i64, primitive, 5,
