...
public class MediaCodecUtil {
    ...
    public static class CodecCapabilityInfo {
        ...
        public boolean isSecureRequired() {
            // MediaCodecList is supposed to feed us names of decoders that do NOT end in ".secure".
            //  We
            // are then supposed to check if FEATURE_SecurePlayback is supported, and if it is and
            // we
            ...
            if (mDecoderName.endsWith(SECURE_DECODER_SUFFIX)) {
                // If a decoder name ends with ".secure", then we don't want to use it for clear
                // content.
                return true;
            }
