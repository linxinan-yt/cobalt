...
#if BUILDFLAG(IS_LINUX) && !BUILDFLAG(IS_COBALT_HERMETIC_BUILD) || BUILDFLAG(IS_CHROMEOS)#include "components/services/font/public/mojom/font_service.mojom.h"  // nogncheck
