...
assertEquals("Should trim, toFractionLong", static_cast<int64_t>(54), static_cast<int64_t>(dq.toFractionLong(false)));    assertEquals("Should trim, toDouble", 76.54, dq.toDouble());
