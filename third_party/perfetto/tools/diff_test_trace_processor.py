...
args.winscope_extensions = os.path.join(protos_path, 'perfetto', 'trace',
  ...
  if args.gpu_interned_data_extensions is None:
    args.gpu_interned_data_extensions = os.path.join(
        protos_path, 'perfetto', 'trace', 'gpu', 'gpu_interned_data.descriptor')  if args.simpleperf_descriptor is None:
...
gpu_extensions=args.gpu_extensions,
      gpu_interned_data_extensions=args.gpu_interned_data_extensions,      simpleperf_descriptor=args.simpleperf_descriptor,
